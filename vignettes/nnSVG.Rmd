...
For faster runtime in this example, we subsample the dataset to keep only a small number of genes. For a full analysis, the subsampling step can be skipped.
