...
The `nnSVG` package can be installed from Bioconductor.

The following code will install the latest stable release version from Bioconductor. Additional details are shown on the [Bioconductor](https://bioconductor.org/packages/nnSVG) page.

```{r, eval=FALSE}
BiocManager::install("nnSVG")
```

The latest development version can also be installed from the [devel](http://bioconductor.org/developers/how-to/useDevel/) version of Bioconductor or from [GitHub](https://github.com/lmweber/nnSVG).
