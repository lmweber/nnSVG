...
For faster runtime in this example, we subsample the dataset after gene filtering to keep only a small number of genes. For a full analysis, the subsampling step can be skipped.
...
```{r}
# subsampling to select small number of random genes and several known SVGs for 
